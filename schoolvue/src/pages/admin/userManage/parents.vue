    ...
    <div class="divTable">
      <table>
        ...
        <tr v-for="(x,i) in currentPageData">
          ...
          <td style="width: 10%" v-if="x.username==1">父亲</td>
          <td style="width: 10%" v-if="x.username==2">母亲</td>
          <td style="width: 10%" v-if="x.username==3">爷爷</td>
          <td style="width: 10%" v-if="x.username==4">奶奶</td>
          <td style="width: 10%" v-if="x.username==5">外爷</td>
          <td style="width: 10%" v-if="x.username==6">外婆</td>
          <td style="width: 10%" v-if="x.username==7">其他</td>
